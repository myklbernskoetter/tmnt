<template>
  <div class="wrapper heroes-wrapper">
    ...
    <!-- Game Started -->
    <div class="container" :class="{started : started}" v-if="started">
      <div v-if="!started">
        <h1 class="h1">Select Your Hero</h1>
      </div>
      <ul class="character-list">
...
.character-list {
  ...
  .character.hero {
    ...
    .image-wrapper {
      ...
      animation: gridSlideIn 250ms linear forwards;
      overflow: hidden;
      opacity: 0;
      z-index: 2;
...
.started {
  ...
  .image-wrapper {
    ...
    transform: translateY(0);
    opacity: 1;
    animation: none 500ms linear forwards;
  }
...
.attribute-slide-enter-active {
  transition: all 0.3s ease;
}
.attribute-slide-leave-active {
  transition: all 0.8s cubic-bezier(1, 0.5, 0.8, 1);
}
.attribute-slide-enter,
.attribute-slide-leave-to {
